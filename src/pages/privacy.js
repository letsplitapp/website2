                           ...
                           <p>9426-9081 Quebec Inc. f.a.s. Let’s Split (“<strong>Let’s Split</strong>”, “<strong>our</strong>”, “<strong>us</strong>”, “<strong>we</strong>”), a company offering a simple way to split expenses with anyone, takes your privacy and the protection of your personal information seriously. This Privacy Policy (the “<strong>Policy</strong>”) describes our data protection practises, the types of Personal Information we may receive or collect from you and of how we use, disclose, store and secure it. By doing so, you will be able to make wise and informed choices.</p>
                            <p>This Policy applies to our application available through the various applications markets (our “<strong>Application</strong>”). However, we wish to draw your attention to the fact that the rights and obligations described in this Policy do not cover third-party websites that may be linked to or  mentioned on our Application as well as any third-party services that may be used within our Application. These third-party websites and services have their own privacy policies and we encourage you to read them carefully before accessing them, using them or otherwise providing Personal Information to them.</p>
                                ...
                                <p>The Personal Information that we collect may include, but is not limited to:</p>
                                    ...
                                    <p><ul>    
                                        <li>
                                            Your contact information, such as a name and last name, birthdate, email address, telephone number, postal address, country of residence in order to identify and correspond with you;</li>
                                        ...
                                        <li>
                                            Any other Personal Information that you have provided to us, for example, expenses descriptions and amounts, group names, payments, reminders, receipt images, notes, memos or any other information that you share while using our Application.
                                        </li>
                                    </ul>
                                </p>
                                <h4>3.   HOW DO WE COLLECT YOUR PERSONAL INFORMATION?</h4>
                                    ...
                                    We might also collect technical information through the use of Cookies. For more information in this regard, we invite you to read the Section, “How do we use Cookies?”.</p>
                                ...
                                <p>Let’s Split does not rent nor sell any of your Personal Information to third parties and will not share it with third parties without your consent unless it is necessary to do so by law or for the Purposes as set forth below.</p>
                                    ...
                                    <h4>6.   WHERE IS YOUR PERSONAL INFORMATION STORED AND TRANSFERRED?</h4>
                                <p>
                                    Your Personal Information may be held by Let’s Split in locations other than your province, territory, state, or country of residence, including in Canada and the province of Quebec. Let’s Split may also subcontract processing to or share your Personal Information with third parties located elsewhere, including locations other than your province, territory, state, or country of residence. In such case, Let’s Split will ensure that your Personal Information is transferred to countries that have received an adequacy decision from the competent authority, or that your Personal Information is adequately protected by appropriate technical, organizational, contractual, or other lawful means. If you would like to obtain more information on these security measures, please contact us as set forth in the Section “How to contact us?”.
                                </p>
                                <h4>7.   HOW LONG DO WE RETAIN YOUR PERSONAL INFORMATION?</h4>

                                <p>
                                    Personal Information will be retained only as long as necessary for the fulfillment of the Purposes or as required by law. At the end of such period, we strive to destroy or anonymize this information. To determine the appropriate retention period for your Personal Information, we consider the amount, nature and sensitivity of the Personal Information, the potential risk of harm from unauthorized use or disclosure of your Personal Information, the Purposes for which we process your Personal Information and whether we can achieve those Purposes through other means, and the applicable legal, regulatory, tax, accounting or other requirements. If you would like more information on this subject, we invite you to contact us.
                                </p>

                                <h4>8.   HOW DO WE PROTECT YOUR PERSONAL INFORMATION?</h4>

                                <p>With necessary and appropriate security measures</p>
                                    <p>Let’s Split has security measures in place to protect your Personal Information. The standard security measures we use will depend on the type of information collected. However, Let’s Split uses physical, electronic, and procedural safeguards that comply with applicable regulations to protect your Personal Information. We encourage you to be cautious when using the Internet. This includes not sharing your passwords. If you think an unauthorized account has been created using your name, please contact us as set forth in the Section “How to contact us?”.</p>
                                    <p>Children’s privacy</p>
                                    <p>The Application is only available and designed for individuals of legal age. Let’s Split does not knowingly process any Personal Information from minors. If you believe that Personal Information has been collected from a minor, or if you are a parent or legal guardian and think that your child has provided us with Personal Information, you may contact us as set forth in the Section “How to contact us?”.</p>

                                <h4>9.   HOW DO WE USE COOKIES?</h4>
                                ...
                                <p>If you have consented to their use, Let’s Split and/or its third-party partners may also use non-essential Cookies in connection with the the following:</p>
                                    <p>
                                        <ul>
                                            ...
                                            <li>
                                                <u>Performance Cookies (also known as “statistical Cookies” or “analytical Cookies”)</u>: These Cookies are not essential to the provision of our services. If you have consented to their use, we use performance Cookies to understand how you interact with our Application. Our partners may also use this type of Cookie to analyze your use of our Application and provide us with information about it. These Cookies are for statistical purposes only. For more information on our use of Cookies, see the “Use of Analytics Tools” section.
                                            </li>
                                        </ul>
                                    </p>
                                    <p>Deactivation of Cookies to Which You Have Consented</p>
                                    <p>Except for strictly necessary Cookies, we will only place Cookies on your device if you consent to it, and such Cookies will be kept for a maximum period of thirteen months from when they are placed on your device. At the end of this period, your consent will be required again. You can also manage your Cookie settings by changing the settings on your browser or device. For details on how to set up your browser, please see the Help Centre for Chrome, Safari, Firefox, Internet Explorer, Edge or Opera. However, if you choose to decline Cookies, some pages or sections of our Application may not display properly or some features may not be available.</p>

                                <h4>10.   WHAT ARE YOUR RIGHTS?</h4>

                                <p>Depending on applicable laws, you might have different rights such as the right to be forgotten, the right to obtain access to, or rectification of your Personal Information, the right to withdraw your consent (if any), the right not to be discriminated against, the right to restrict and to object to the use and processing of your Personal Information by us, or the right to data portability by, namely, receiving a copy of all Personal Information that Let’s Split has about you in a structured, commonly used and machine-readable format. To exercise any of these rights (to the extent available), please contact us as set forth in the Section “How to contact us?”.</p>

                                <h4>11.   HOW TO CONTACT US?</h4>

                                <p>If you have any questions about any aspect of this Policy, wish to send a comment, make a complaint or exercise any of the rights made available to you according to applicable laws, please do so through the “Contact us” link on the Application, when available, or please contact our Data Protection Officer as follows:</p>
                                    <p>
                                        Data Protection Officer<br></br>
                                        support@letsplit.com
                                    </p>
