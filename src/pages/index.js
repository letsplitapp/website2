  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content="Manage. Share. Pay. Get Paid. Let's Split makes it easy to split bills and settle up, so you can effortlessly manage expenses with friends and family. Spend more time having fun and less time managing expenses - try Let's Split today!"
        />
        <meta
          name="keywords"
        ...
        <meta
          ...
          content="Effortlessly manage group expenses and payments with Let's Split. Easily manage expenses, assign to members, and settle up. Try it today!"
        />
      ...
      <main style={pageStyles}>
            ...
            <div className="column column-content">
              <div>
                ...
                <div className="header-description">
                  <p>
                    ...
                    <span className="color-blue">
                      Share. Track. Split. Pay. Join the Let's Split community
                      today.
                    </span>
                  </p>
                </div>
                <div className="app-button desktop">
                  ...
                  <span href="" onClick={() => setisModalOpen(true)}>
                    <img src={GooglePlay} />
                  </span>
                </div>
                <div className="app-button mobile">
                  <a
                    href="https://apps.apple.com/ca/app/lets-split/id1625176396?itsct=apps_box_badge&amp;itscg=30200"
                    target="_blank"
                  >
                    <img src={AppStore} />
                  </a>
                  <a
                    href="https://play.google.com/store/apps/details?id=com.letsplit.app&referrer=utm_source%3Dwebsite%26utm_medium%3Dheader%26utm_content%3Dmobile"
                    target="_blank"
                  >
                    <img src={GooglePlay} />
                  </a>
        ...
        <section>
          <div className="container inverse easier-section">
            <div className="column column-content">
              <p>
                Let’s Split app makes it easier to track and come to terms with
                shared expenses.
              </p>
              <p>
                Track, send and receive money with your roommates, loved ones or
          ...
          <div className="container anything-section">
            <div className="column column-content">
              <div>
                ...
                <p>
                  Split <span className="color-blue">any</span> and{" "}
                  <span className="color-blue">all</span> expenses
                </p>
        ...
        <section>
          <div className="container inverse select-section">
            <div className="column column-content">
              ...
              <p>
                Get started by creating a group with your friends, roommates, or
                travel companions. Groups serve as the central hub for managing
                all shared expenses, whether it's for trips, parties, or
                everyday bills.
              </p>
        ...
        <section className="bg-blue ">
          <div className="container choose-section">
            <div className="column column-content">
              <h3>Add Expenses</h3>
              <p>
                Whenever someone in your group incurs an expense, simply enter
                the date, amount, and a brief description in the app. No more
        ...
        <section>
          <div className="container inverse split-section">
            <div className="column column-content">
              ...
              <p>
                Our app tracks each member's share of the expenses and
                calculates who owes what to whom. Say goodbye to confusion and
                hello to clarity.
              </p>
              <div className="button">
                <a className="button-blue" href="#signup">
        ...
        <section className="bg-blue get-paid-custom-mb">
          <div className="container get-paid-section">
            <div className="column column-content">
              ...
              <p>
                When it's time to settle up, Let's Split offers an integrated
                payment system for secure, direct transactions through the app.
                This ensures that everyone gets reimbursed quickly and
                conveniently.
              </p>
              <div className="button">
                <a className="button-blue" href="#signup">
        ...
        {isModalOpen && (
          <div className="popup-overlay" onClick={() => setisModalOpen(false)}>
            <div className="popup">
